...
public class RapidMinerImpl {
    ...
    public void writeModel(int size, TermsController controller) throws Exception {
        ...
        Operator operator = OperatorService.createOperator(ClusterModelWriter.class);
        ClusterModelWriter clusterWriter = new ClusterModelWriter(operator.getOperatorDescription());
